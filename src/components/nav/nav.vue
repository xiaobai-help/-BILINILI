  ...
  <div>
    <div class="nav">
      <ul class="nav-left">
        <li class="nav-logo">
          <a href="javascript:;">
            <img src="./img/bilibili.png" alt="" style="width: 4.285rem" />
          </a>
        </li>
        <li class="nav-center">
          <a href="javascript:;">
        ...
        <li>
          <a href="javascript:;">
            <span class="nav-animation right-entry-icon">番剧</span>
          </a>
        </li>
        <li>
          <a href="javascript:;">
            <span class="nav-animation right-entry-icon">直播</span>
          </a>
        </li>
        <li>
          <a href="javascript:;">
            <span class="nav-animation right-entry-icon">游戏中心</span>
          </a>
        </li>
        <li>
          <a href="javascript:;">
            <span class="nav-animation right-entry-icon">会员购</span>
          </a>
        </li>
        <li>
          <a href="javascript:;">
            <span class="nav-animation right-entry-icon">漫画</span>
          </a>
        </li>
        <li>
          <a href="javascript:;">
            <span class="nav-animation right-entry-icon">赛事</span>
          </a>
        </li>
        <li>
          <a href="javascript:;">
            <span class="kuawantext">跨晚</span>
            <img
              src="https://i0.hdslb.com/bfs/banner/593a73f29436ed16ae2491a4aacf22e485824e81.png"
              alt=""
              class="kuawanimg"
            />
          </a>
        </li>
        <li class="nav-center nav-ten">
          <a href="javascript:;">
            <svg
              width="16"
              height="16"
      ...
      <ul class="nav-right">
        ...
        <li class="nav-center">
          <a href="javascript:;">
            <svg
              class="nav-animation right-entry-icon"
              width="20"
              height="20"
              viewBox="0 0 20 20"
              fill="none"
    ...
    <Login v-if="show" @Down="down"></Login>
  </div>
</template>
      ...
      var timer = setInterval(function () {
        ...
        setTimeout(function () {
          $(".kuawantext").animate(
            ...
            function () {
              $(".kuawantext").css("display", "none");
              $(".kuawanimg").css("display", "block");
              $(".kuawanimg").animate({
                top: 14,
              });
              $(".kuawantext").animate(
                ...
                function () {
                  setTimeout(function () {
                    $(".kuawanimg").animate(
                      ...
                      function () {
                        $(".kuawanimg").css("display", "none");
                        $(".kuawantext").animate({
                          top: 0,
                        });
                        $(".kuawantext").css("display", "block");
                        $(".kuawanimg").animate({
                          top: 50,
                        });
                      }
